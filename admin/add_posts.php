...
<section class="post-editor">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <select name="category" class="box" required>
         ...
         <option value="animations">Divisi IPTEK</option>
         <option value="animations">Divisi HUMAS</option>
         <option value="animations">Divisi KOMINFO</option>
         <option value="animations">Divisi DANUS</option>
      </select>
      <p>post image</p>
